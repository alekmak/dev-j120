...
public class MainFrame extends JFrame {
    ...
    public MainFrame(OrderClientsController controller, ProductClientsController productController) {
    ...
    private void addClient() {
        ...
        if (dlg.isModalResult()) {
            ProductDialog productDialog = new ProductDialog(dlg, controller, productController);
            productDialog.setLocationRelativeTo(dlg);
            productDialog.setVisible(true);
            if (productDialog.isModalResult()) {
